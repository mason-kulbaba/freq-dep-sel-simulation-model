...
#from Graham Coop "Updated 2 locus selection simulation code to generate frequency dependent selection, w dominance, to show effect of recombination & why super genes are selected for."
